...
def _success_msg(language: str) -> str:
    if language == "hinglish":
        return "Yeh raha aapka personalized investment plan! 📄✨\n\nIse apne advisor ke saath share kar sakte hain."
    return "Here's your personalized investment plan! 📄✨\n\nFeel free to share it with your advisor."
